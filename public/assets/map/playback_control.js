...
'  <div class="transport">' +
'    <div class="navbar">' +
'      <div class="navbar-inner"  style="border-bottom: none; border-bottom-left-radius: 0; border-bottom-right-radius: 0;">' +
'      <ul class="nav text-center pull-right" style="padding-top: 10px;margin-right: 5%;">' +
'<li style="margin-left: 15px;; margin-right: 15px; font-weight: bold;" id="imei"></li>' +
'<li style="margin-left: 15px; margin-right: 15px; font-weight: bold;" id="no"></li>' +
'<li style="margin-left: 15px; margin-right: 15px; font-weight: bold;" id="model"></li>' +
'<li style="margin-left: 15px; margin-right: 15px; font-weight: bold;" id="type"></li>' +
'<li style="margin-left: 15px; margin-right: 15px; font-weight: bold;" id="office"></li>' +
'<li style="margin-left: 15px; margin-right: 15px; font-weight: bold;" id="name"></li>' +
...
'  <div class="transport">' +
'    <div class="navbar">' +
'      <div class="navbar-inner" style="border-top: none; border-top-left-radius: 0; border-top-right-radius: 0;">' +
'        <ul class="nav">' +
'          <li class="ctrl">' +
...
'</div>',
  ...
  _setup: function () {
      $("span:contains('GPS Tracks')").text(" عرض النقاط");
